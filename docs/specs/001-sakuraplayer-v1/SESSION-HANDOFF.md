...
**当前阶段**: TASK-311 completed：HarmonyOS 字幕音轨进度与生命周期（TrackStore/SubtitleCache/ProgressStore）。下一步 TASK-312（播放器剩余项：外部字幕真实行为/心跳真机验证）。
